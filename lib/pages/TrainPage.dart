...
class TraninPageState extends State<TrainPage> with SingleTickerProviderStateMixin {
  ...
  double begin = 0.0;
  double end = 1000;
  String _time =  DateUtil.getDateStrByDateTime(DateTime.now(),format: DateFormat.ZH_MONTH_DAY) + " "+  DateUtil.getZHWeekDay(DateTime.now());//2018年09月16日 23时16分15秒
//
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.push<Place>(context, MaterialPageRoute(builder: (BuildContext context){
                                          return CitiesWidget(isStart: true,start:mPlaceOfDeparture ,end: mDestination,);
                                        })).then((Place place){
                                          setState(() {
                                            mPlaceOfDeparture = place.start;
                                            mDestination = place.end;
                                          });
                                        });
                                      },
                                      child:
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.push<Place>(context, MaterialPageRoute(builder: (BuildContext context){
                                          return CitiesWidget(isStart: false,start: mPlaceOfDeparture,end: mDestination,);
                                        })).then((Place place){
                                          setState(() {
                                            mPlaceOfDeparture = place.start;
                                            mDestination = place.end;
